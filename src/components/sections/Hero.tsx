...
import Planet1 from '../illustrations/Planet1';
    ...
    <Flex
      ...
      <Box
        ...
        <Box
          ...
          right={{ base: '10', lg: '100' }}>
          <motion.div
            animate={{ x: [0, 3, 0], y: [0, 3, 0] }}
            transition={{ duration: 3, repeat: Infinity }}>
            {colorMode === 'dark' ? <Planet1 /> : ''}
          </motion.div>
        </Box>
        <Box
          pos='absolute'
          w={"sm"}
          h='full'
          top={{ base: '60vh', lg: '60vh' }}
          right={{ base: '20vw', lg: '70vw' }}>
          <motion.div
            animate={{ x: [0, 3, 0], y: [0, 3, 0] }}
            transition={{ duration: 3, repeat: Infinity }}>
          ...
          <HStack spacing={6}>
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Button
                ...
                height='60px'
                bgGradient={useColorModeValue(
                  'linear(to-tr, cyan.200, blue.600)',
                  'linear(to-tr, cyan.200, blue.600)'
                )}
                roundedTopLeft={'32'}
                roundedBottomRight={'32'}
