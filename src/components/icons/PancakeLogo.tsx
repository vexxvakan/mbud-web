...
export default function PancakeLogo() {
  return (
    <Icon
        h={"150"}
      viewBox='0 0 30 35'
	...
	c0-3.2,2.8-6,7-7.6L7,4.8z'
      ...
      <path d="M11.8,18.9c0,1.3-0.7,2.4-1.6,2.4c-0.9,0-1.6-1.1-1.6-2.4s0.7-2.4,1.6-2.4C11.1,16.5,11.8,17.6,11.8,18.9z"/>
<path fill="#63300" d="M22.9,18.9c0,1.3-0.7,2.4-1.6,2.4c-0.9,0-1.6-1.1-1.6-2.4s0.7-2.4,1.6-2.4C22.2,16.5,22.9,17.6,22.9,18.9z"/>
    </Icon>
  );
}
